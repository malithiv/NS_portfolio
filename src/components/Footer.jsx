      ...
      <div className="container">
        <div className="footer-grid">
          <div className="footer-info">
            <div className="footer-logo">
              ...
              <span className="logo-text">Nova<span className="text-accent">Script</span></span>
            </div>
            <p className="footer-description">
              Innovative software solutions for forward-thinking businesses. We build digital experiences that drive growth and transform industries.
            </p>
        ...
        <div className="footer-bottom">
          <p className="copyright">
            &copy; {new Date().getFullYear()} Nova Script. All rights reserved.
          </p>
