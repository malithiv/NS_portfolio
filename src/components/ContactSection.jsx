            ...
            <div className="contact-items">
              <div className="contact-item">
                ...
                <div>
                  ...
                  <p className="contact-item-text">509/4, Maragahawatte, Angoda</p>
                </div>
              </div>
              ...
              <div className="contact-item">
                ...
                <div>
                  ...
                  <p className="contact-item-text">novascriptpvtltd@gmail.com</p>
                  {/* <p className="contact-item-text">support@novascript.com</p> */}
                </div>
              </div>
              ...
              <div className="contact-item">
                ...
                <div>
                  ...
                  <p className="contact-item-text">+94 76 946 3101</p>
                  <p className="contact-item-text">+94 76 914 6421</p>
                </div>
              </div>
            </div>
